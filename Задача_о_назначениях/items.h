...
struct item
{
	...
	int number = 0;//sizeof(criterion)/sizeof(*criterion); //Число критериев объекта/субъекта
};
...
public:
	...
	static void set_number(int); //Задание числа объектов/субъектов
	static int get_number(); //Получение числа объектов/субъектов
